...
#### You have used flutter before and have a good understanding of the framework. You are familiar with the async-await concept and what APIs are.
...
2. Understanding of the API structure
3. Well structured Widget tree
4. No Redundancy
5. Creativity
...
2. Then create a Pull Request from your branch to this (flutter-option2) branch
...
- **Flutter Tutorials:**
  - How to fetch JSON data from an API
    ...
    [![IMAGE ALT TEXT HERE](https://img.youtube.com/vi/aIJU68Phi1w/0.jpg)](https://www.youtube.com/watch?v=aIJU68Phi1w)
  - [Tutorial using JSON objects with multiple fields](https://www.kindacode.com/article/how-to-fetch-data-from-apis-in-flutter/)
