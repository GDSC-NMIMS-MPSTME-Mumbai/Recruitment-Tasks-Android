![](https://res.cloudinary.com/startup-grind/image/upload/dpr_2.0,fl_sanitize/v1/gcs/platform-data-dsc/contentbuilder/logo_dark_horizontal_097s7oa.svg)ad.png)
...
#### You don't have an in-depth knowledge of flutter yet. You are just starting as an Android developer and are eager to learn and implement new things.
Display your creativity and resilience by completing this task and meeting all the criteria.

[comment]: <> (outline details)
## Task Details:
In this task, you have to implement a simple Weather App that has (at least) <strong>3 different screens for 3 different kinds of weather</strong> such as - Sunny, Cloudy and Raining.
- Navigation between these screens is <b>not</b> required, i.e. these can be developed independently
...
You may only work on and make changes to this project. You may not use an existing project.
...
1. Unique and Clean UI
2. Well structured Widget tree
3. Creativity

[comment]: <> (submission process)
## How to Submit?
1. Commit your code to your branch
2. Then create a Pull Request from your branch to this (flutter-option1) branch
